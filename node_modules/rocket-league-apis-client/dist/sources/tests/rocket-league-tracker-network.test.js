...
describe('Rocket League Tracker Network', function () {
  ...
  describe('formatResponse', function () {
    it('Should properly format the response', function () {
      return expect((0, _rocketLeagueTrackerNetwork.formatResponse)(_rocketLeagueTrackerNetworkResponseMock2.default)).to.deep.equal(_rocketLeagueTrackerNetworkFormattedInformationMock2.default);
    });
  });
});